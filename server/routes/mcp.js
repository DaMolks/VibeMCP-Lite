...
router.post('/execute', async (req, res) => {
  try {
    ...
    // Envoyer la notification à Claude Desktop si configuré
    sendToClaudeDesktop(command, result);
...
// Envoie des notifications à Claude Desktop
async function sendToClaudeDesktop(command, result) {
  ...
  try {
    ...
    console.error('Failed to send notification to Claude Desktop:', error.message);
  }
}
